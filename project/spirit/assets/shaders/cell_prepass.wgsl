// NOTE: when updating: copy-paste this bastard from: https://github.com/bevyengine/bevy/blob/latest/crates/bevy_pbr/src/prepass/prepass.wgsl
// and modify it.
