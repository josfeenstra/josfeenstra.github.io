...
fn detect_edge(frag_coord: vec4<f32>, sample_index: u32) -> f32 {
    let sobel_1 = detect_edge_normal(frag_coord, sample_index);
    let sobel_2 = detect_edge_depth(frag_coord, sample_index);
    return max(sobel_1, sobel_2);
}
...
fn fragment(
  ...
  @builtin(sample_index) sample_index: u32,
    ...
    // var edge_detection = detect_edge(in.clip_position, sample_index);
